...
def tile_map(tile_map: TileMap):
    screen_width = GLOBAL_SETTINGS.size.window
    screen_height = GLOBAL_SETTINGS.size.window
    ...
    tm_w = tile_map.tiles_wide * GLOBAL_SETTINGS.size.tile
    tm_h = tile_map.tiles_high * GLOBAL_SETTINGS.size.tile
